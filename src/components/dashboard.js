...
//     const limit = 1000; // Define the limit for highlighting
...
//                         />
//                         <div className="popup-actions">
//                             <button className="submit-button" onClick={handleEditTransaction}>Save Changes</button>
        ...
        datasets: [
            {
                ...
                pointBorderWidth: 2,
                lineTension: 0.2, // Smoothness of the line; adjust as needed
            }
        ]
    };
